...
<form class="register" action="UsersController" method = "post" name="login.do" id="inForm">
<input type = "hidden" value="login" name= "command">
   ...
   <input type="text" class="text-field" placeholder="아이디(이메일)" name="id" id="id" />
    ...
    <br><br><br>
    <input type="submit" value="LOGIN" class="button" name="btn" id="btn" />
    <br><br>
    <a href = "A.do" onclick="window.location.href=this.href; return false;">Sign Up</a>
