      ...
      -${sessionScope.userLoginInfo.name}-
               ...
               <aside class="col-md-4">
                	 <div class="widget blog_gallery">
                        <h3>Photos</h3>
                        <ul class="sidebar-gallery2">
                        
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="festivalP/${vo.festivalNum}/${vo.festivalNum}_1.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="festivalP/${vo.festivalNum}/${vo.festivalNum}_1.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i>View</a>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="festivalP/${vo.festivalNum}/${vo.festivalNum}_2.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="festivalP/${vo.festivalNum}/${vo.festivalNum}_2.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i>View</a>
                            </div> 
                        </div>
                    </div>
                   
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="festivalP/${vo.festivalNum}/${vo.festivalNum}_3.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="festivalP/${vo.festivalNum}/${vo.festivalNum}_3.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i>View</a>
                            </div> 
                        </div>
                    </div>
                    
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="festivalP/${vo.festivalNum}/${vo.festivalNum}_4.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="festivalP/${vo.festivalNum}/${vo.festivalNum}_4.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i>View</a>
                            </div> 
                        </div>
                    </div>
                    
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="festivalP/${vo.festivalNum}/${vo.festivalNum}_5.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="festivalP/${vo.festivalNum}/${vo.festivalNum}_5.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i>View</a>
                            </div> 
                        </div>
                    </div>
                       <!-- asdasd -->
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="festivalP/${vo.festivalNum}/${vo.festivalNum}_6.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="festivalP/${vo.festivalNum}/${vo.festivalNum}_6.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i>View</a>
                            </div>    
                        </div>
                    </div>
                  </ul>
